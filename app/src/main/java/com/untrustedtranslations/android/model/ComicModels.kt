...
data class TextBlock(
    ...
    /**
     * Optional pixel-accurate text mask (from the same segmentation model used for background
     * cleaning) for this block's own region, used to draw a real outline around the glyphs
     * themselves in the editor instead of a bounding-box rectangle. Null until computed, and
     * always null for manually added text (there's no source lettering to trace).
     */
    val maskSource: Uri? = null,
