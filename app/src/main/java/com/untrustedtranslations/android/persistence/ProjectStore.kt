...
object ProjectStore {
    ...
    private fun pageToJson(page: ComicPage) = JSONObject().apply {
        ...
        put("cleanedSource", page.cleanedSource?.path ?: JSONObject.NULL)
    ...
    private fun pageFromJson(json: JSONObject): ComicPage {
        ...
        return ComicPage(
            ...
            cleanedSource = json.optString("cleanedSource").takeIf { it.isNotBlank() }
    ...
    private fun blockToJson(block: TextBlock) = JSONObject().apply {
        ...
        put("maskSource", block.maskSource?.path ?: JSONObject.NULL)
    ...
    private fun blockFromJson(json: JSONObject): TextBlock {
        ...
        return TextBlock(
            ...
            maskSource = json.optString("maskSource").takeIf { it.isNotBlank() }?.let { Uri.fromFile(File(it)) },
            style = TextStyle(
